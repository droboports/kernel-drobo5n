...
MV_CPU_DEC_WIN SYSMAP_ARMADA_XP[] = {
	...
	{{SDRAM_CS0_BASE,		0,	SDRAM_CS0_SIZE		},	0,		EN},	/* SDRAM_CS0 */
	...
	{{DEVICE_CS0_PHYS_BASE,		0,	DEVICE_CS0_SIZE,	},	15,		EN},	/* DEVICE_CS0 */
	{{DEVICE_CS1_PHYS_BASE,		0,	DEVICE_CS1_SIZE,	},	19,		DIS},	/* DEVICE_CS1 */
	...
	{{PEX0_MEM_PHYS_BASE,		0,	PEX0_MEM_SIZE		},	0,		DIS},	/* PEX0_MEM */
	{{PEX0_IO_PHYS_BASE,		0,	PEX0_IO_SIZE		},	1,	        DIS},	/* PEX0_IO */
	{{PEX1_MEM_PHYS_BASE,		0,	PEX1_MEM_SIZE		},	2,		DIS},	/* PEX1_MEM */
	{{PEX1_IO_PHYS_BASE,		0,	PEX1_IO_SIZE		},	3,	        DIS},	/* PEX1_IO */
	{{PEX2_MEM_PHYS_BASE,		0,	PEX2_MEM_SIZE		},	4,		DIS},	/* PEX2_MEM */
	{{PEX2_IO_PHYS_BASE,		0,	PEX2_IO_SIZE		},	5,	        DIS},	/* PEX2_IO */
	{{PEX3_MEM_PHYS_BASE,		0,	PEX3_MEM_SIZE		},	6,		DIS},	/* PEX3_MEM */
	{{PEX3_IO_PHYS_BASE,		0,	PEX3_IO_SIZE		},	7,	        DIS},	/* PEX3_IO */
	{{PEX4_MEM_PHYS_BASE,		0,	PEX4_MEM_SIZE		},	18,		EN},	/* PEX4_MEM */
	{{PEX4_IO_PHYS_BASE,		0,	PEX4_IO_SIZE		},	19,	        DIS},	/* PEX4_IO */
	{{PEX5_MEM_PHYS_BASE,		0,	PEX5_MEM_SIZE		},	0,	        DIS},	/* PEX5_MEM */
	{{PEX5_IO_PHYS_BASE,		0,	PEX5_IO_SIZE		},	0,	        DIS},	/* PEX5_IO */
	{{PEX6_MEM_PHYS_BASE,		0,	PEX6_MEM_SIZE		},	0,	        DIS},	/* PEX6_MEM */
	{{PEX6_IO_PHYS_BASE,		0,	PEX6_IO_SIZE		},	0,	        DIS},	/* PEX6_IO */
	{{PEX7_MEM_PHYS_BASE,		0,	PEX7_MEM_SIZE		},	16,	        EN},	/* PEX7_MEM */
	{{PEX7_IO_PHYS_BASE,		0,	PEX7_IO_SIZE		},	17,	        DIS},	/* PEX7_IO */
	{{PEX8_MEM_PHYS_BASE,		0,	PEX8_MEM_SIZE		},	8,		EN},	/* PEX8_MEM */
	{{PEX8_IO_PHYS_BASE,		0,	PEX8_IO_SIZE		},	9,	        DIS},	/* PEX8_IO */
	{{PEX9_MEM_PHYS_BASE,		0,	PEX9_MEM_SIZE		},	10,		DIS},	/* PEX9_MEM */
	{{PEX9_IO_PHYS_BASE,		0,	PEX9_IO_SIZE		},	11,	        DIS},	/* PEX9_IO */
	{{INTER_REGS_PHYS_BASE,		0,	INTER_REGS_SIZE		},	20,	        EN},	/* INTER_REGS */
	{{UART_REGS_BASE,		0,	UART_SIZE		},	0,      	DIS},	/* DMA_UART */
	{{SPI_CS0_PHYS_BASE,		0,	SPI_CS0_SIZE		},	SPI_CS0_WIN,	EN},	/* SPI_CS0 */
	...
	{{BOOTROM_PHYS_BASE,		0,	BOOTROM_SIZE		},	14,		EN},	/* BOOTROM */
	{{DEVICE_BOOTCS_PHYS_BASE,	0,	DEVICE_BOOTCS_SIZE	},	13,		EN},	/* DEV_BOOCS */
	{{PMU_SCRATCH_PHYS_BASE,	0,	PMU_SCRATCH_SIZE	},	TBL_UNUSED,	DIS},	/* PMU SCRATCHPAD */
	{{CRYPT_ENG_PHYS_BASE(0),	0,	CRYPT_ENG_SIZE		},	15,		DIS},	/* CRYPT0_ENG */
	{{CRYPT_ENG_PHYS_BASE(1),	0,	CRYPT_ENG_SIZE		},	0,		DIS},	/* CRYPT1_ENG */
