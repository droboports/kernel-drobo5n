...
void __init arm_memblock_init(struct meminfo *mi, struct machine_desc *mdesc)
{
	...
	for (i = 0; i < mi->nr_banks; i++)
        ...
        memblock_reserve(0x53000000,0x29000000); /* Drobo - reserving NAS shared mem */
        if (!memblock_is_region_memory(0x53000000,0x29000000) ) {
            pr_err("Drobo memory reserve failure!!!\n" );
        }
