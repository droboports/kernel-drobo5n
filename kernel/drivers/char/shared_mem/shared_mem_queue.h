...
#define SHM_DB_CAUSE_REG        (CPU_DOORBELL_IN_REG | 0x900) //AXP_IN_DRBEL_CAUSE) 
#define SHM_DB_MASK_REG         (CPU_DOORBELL_IN_MASK_REG | 0x900) //AXP_IN_DRBEL_MSK) 
#define SHM_DB_CAUSE_REG_MASK   0xffff0000
#define SHM_DB_CAUSE_REG_SHIFT  16
#define DOORBELL_IN_IRQ         (IRQ_AURORA_IN_DRBL_HIGH) 
...
typedef struct _shm_queue_os_info
{
	...
	shm_q_bit_shift_to_queue_index db_to_q_index[SHM_QUEUE_MAX_DOORBELL_BIT_SHIFT];
} shm_queue_os_info;
