...
#define SHARED_MEMORY_PHYS_TOP                          (0x7C000000)
#define SHARED_MEMORY_HEADER_PHYS_ADDR			(SHARED_MEMORY_PHYS_TOP - SHARED_MEM_GAP - SHARED_MEM_HEADER_PARTITION_SIZE)
#define SHARED_MEMORY_BASE_PHYS_ADDR			(SHARED_MEMORY_HEADER_PHYS_ADDR - SHARED_MEM_TOTAL_SHARED_MEM)
